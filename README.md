...
* добавить **график scaling (threads vs time)**,
* оформить **OND-RNG и детерминизм** как отдельный раздел,
* или сделать **shot-parallelism внутри траектории**.

Просто скажи, как двигаемся дальше.
